          ...
          <div className="flex flex-row p-6">
            ...
            <div className="flex flex-col mt-4">
              ...
              <p className="text-lg text-white/70 mt-2">
                ...
                technologies like React,Nextjs,Tailwind
                CSS,Nodejs,Expressjs,Nestjs and having understanding of
                databases like NoSql,MongoDB,Prisma and many more.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"></div>
          <div className="flex flex-row p-6">
            ...
            <div className="flex flex-col mt-4">
              ...
              <p className="text-lg text-white/70 mt-2">
                I am having more than a year experience in real world industry
          ...
          <div className="flex flex-row p-6">
            ...
            <div className="flex flex-col mt-4">
              ...
              <p className="text-lg text-white/70 mt-2">
                ...
                Nodejs,Expressjs,Nestjs,mongodb,NoSql,Prisma. My expertise
                extends to creating responsive , Scalable applications with
                user-friendly interfaces and effecient backend solutions.
              </p>
            </div>
          </div>
        </div>
